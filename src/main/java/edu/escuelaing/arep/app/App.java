 ...
 * @author  Jairo Pulido
 * @version 1.0.  (26 de Marzo del 2021) 
 */
public class App {
    ...
    public static void main(String[] args) {
        port(getPort());
        get("/cos", (req, res) -> inputDataPage(req, res,"cos"));
    ...
    */
    private static JSONObject inputDataPage(Request req, Response res,String operation) {
        ...
        obj.put("output",(operation.equals("cos"))? calcular.coseno(number) : calcular.logarithm(number));
        return obj;
    }
   /**
